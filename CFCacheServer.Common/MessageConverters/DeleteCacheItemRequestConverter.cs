...
{
    internal class DeleteCacheItemRequestConverter : IExternalMessageConverter<DeleteCacheItemRequest>
    {
        public ConnectionMessage GetConnectionMessage(DeleteCacheItemRequest externalMessage)
        {
        ...
        public DeleteCacheItemRequest GetExternalMessage(ConnectionMessage connectionMessage)
        {
            var externalMessage = new DeleteCacheItemRequest()
            {
