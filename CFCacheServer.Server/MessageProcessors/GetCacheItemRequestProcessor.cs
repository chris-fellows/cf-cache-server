...
{
    internal class GetCacheItemRequestProcessor : MessageProcessorBase, IMessageProcessor
    {
        public GetCacheItemRequestProcessor(ICacheItemServiceManager cacheItemServiceManager, ISimpleLog log, IServiceProvider serviceProvider) : base(cacheItemServiceManager, log, serviceProvider)
        {
        ...
        public Task ProcessAsync(MessageBase message, MessageReceivedInfo messageReceivedInfo)
        {
            return Task.Run(() =>
            {
                var getCacheItemRequest = (GetCacheItemRequest)message;
        ...
        {
            return message.TypeId == MessageTypeIds.GetCacheItemRequest;
        }
    }
}
