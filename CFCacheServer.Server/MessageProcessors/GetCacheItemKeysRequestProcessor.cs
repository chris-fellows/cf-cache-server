...
{
    internal class GetCacheItemKeysRequestProcessor : MessageProcessorBase, IMessageProcessor
    {
        public GetCacheItemKeysRequestProcessor(ICacheItemServiceManager cacheItemServiceManager, ISimpleLog log, IServiceProvider serviceProvider) : base(cacheItemServiceManager, log, serviceProvider)
        {
        ...
        public Task ProcessAsync(MessageBase message, MessageReceivedInfo messageReceivedInfo)
        {
            return Task.Run(() =>
            {
                var getCacheItemKeysRequest = (GetCacheItemKeysRequest)message;
        ...
        {
            return message.TypeId == MessageTypeIds.GetCacheItemKeysRequest;
        }
    }
}
